import React, { useState, useRef, memo, Profiler as ReactProfiler } from 'react'
...
import { Card as PaperCard, Divider as PaperDivider, TextInput, Appbar, withTheme, Title, ActivityIndicator, Text, Button as PaperButton, HelperText as PaperHelperText, Avatar, Subheading as PaperSubheading, Searchbar, Checkbox as PaperCheckbox, IconButton } from 'react-native-paper'
...
// Profile image
export const UserAvatar = memo( ( { size=100, user, ...props } ) => {
...
// Tooltip
export const ToolTip = memo( ( { iconSize=30, containerStyle, tooltipStyle, textStyle, label, info, ...props } ) => {
...
export const Input = memo( ( { style, info, hideInfo=false, error, onSubmit, multiline, iconSize=30, value, ...props } ) => {
...
export const Toggle = memo( ( { style, value, label, onToggle, info, error, ...props } ) => {
